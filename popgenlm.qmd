...
<section class="benchmark-summary" aria-label="PopGenLM Bench v0.2.0 summary">
  ...
  <figure class="benchmark-figure">
    <img src="https://raw.githubusercontent.com/tahirali-biomics/popgenlm-bench/v0.2.0/reports/v0.2/figures/v02_population_gpn_overview.png" alt="Four-panel PopGenLM Bench v0.2.0 overview showing the minor-allele-frequency spectrum, GPN score versus MAF, score distributions across frequency classes, and population-oriented score transformation">
